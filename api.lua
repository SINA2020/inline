 ...
 if redis:get(hash) then
    ...
    return false
		...
		local keyboard = {}
              ...
              edit(q.inline_message_id,'>[راهنمای مالکین گروه(اصلی-فرعی)](https://telegram.me/Nice20Team)\n*[/#!]پنل* --دریافت تنظیمات گروه به صورت اینلاین\n*[/#!]تنظیم قوانین text* --تنظیم قوانین گروه\n*[/#!]تنظیم مدیر* @username|reply|user-id --تنظیم مالک فرعی جدید برای گروه با یوزرنیم|ریپلی|شناسه -فرد\n*[/#!]عزل مدیر* @username|reply|user-id --حذف مالک فرعی از گروه با یوزرنیم|ریپلی|شناسه -فرد\n*[/#!]لیست مالکان* --دریافت لیست مدیران اصلی\n*[/#!]مدیران* --دریافت لیست مدیران فرعی گروه\n*[/#!]setlink link* {لینک-گروه} --تنظیم لینک گروه\n*[/#!]لینک* دریافت لینک گروه\n*[/#!]بن* @username|reply|user-id اخراج کاربر با ریپلی|یوزرنیم|شناسه\n*_______________________*\n>[راهنمای بخش حذف ها](https://telegram.me/Nice20Team)\n*[/#!]عزل مدیران* {حذف تمامی مدیران فرعی تنظیم شده برای گروه}\n*[/#!]تنظیم خوشامد* {حذف پیغام خوش آمدگویی تنظیم شده برای گروه}\n*[/#!]حذف رباتها* {حذف تمامی ربات های موجود در ابرگروه}\n*[/#!]پاک کردن لیست سایلنت* {حذف لیست سکوت کاربران}\n*[/#!]پاک کردن لیست فیلتر* {حذف لیست کلمات فیلتر شده در گروه}\n*_______________________*\n>[راهنمای بخش خوش آمدگویی](https://telegram.me/Nice20Team)\n*[/#!]خوشامد روشن* --(فعال کردن پیغام خوش آمدگویی در گروه)\n*[/#!]خوشامد خاموش* --(غیرفعال کردن پیغام خوش آمدگویی در گروه)\n*[/#!]تنظیم خوشامد متن* --(تنظیم پیغام خوش آمدگویی جدید در گروه)\n*_______________________*\n>[راهنمای بخش فیلترگروه](https://telegram.me/Nice20Team)\n*[/#!]قفل گروه* --فعال کردن فیلتر تمامی گفتگو ها\n*[/#!]بازکردن گروه* --غیرفعال کردن فیلتر تمامی گفتگو ها\n*[/#!]mutechat number(h|m|s)* --فیلتر تمامی گفتگو ها بر حسب زمان[ساعت|دقیقه|ثانیه]\n*_______________________*\n>[راهنمای دستورات حالت سکوت کاربران](https://telegram.me/Nice20Team)\n*[/#!]سایلنت* @username|reply|user-id --افزودن کاربر به لیست سکوت با یوزرنیم|ریپلی|شناسه -فرد\n*[/#!]ازاد سایلنت* @username|reply|user-id --افزودن کاربر به لیست سکوت با یوزرنیم|ریپلی|شناسه -فرد\n*[/#!]لیست سایلنت* --دریافت لیست کاربران حالت سکوت\n*_______________________*\n>[راهنمای بخش فیلتر-کلمات](https://telegram.me/Nice20Team)\n*[/#!]فیلتر کلمه --افزودن عبارت جدید به لیست کلمات فیلتر شده\n[/#!]ازاد فیلتر کلمه* --حذف عبارت جدید از لیست کلمات فیلتر شده\n*[/#!]لیست فیلتر* --دریافت لیست کلمات فیلتر شده\n*_______________________*\n>[راهنمای بخش تنظیم پیغام مکرر](https://telegram.me/Nice20Team)\n*[/#!]تعداد فلود number* --تنظیم حساسیت نسبت به ارسال پیام مکرر\n*[/#!]زمان فلود* --تنظیم حساسیت نسبت به ارسال پیام مکرر برحسب زمان',keyboard)
            end
							------------------------------------------------------------------------
